...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // TO JEST KLUCZOWE! Pozwala na używanie @PreAuthorize("hasAuthority('ADMIN')")
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterBefore(jwtAuthFilter, UsernamePasswordAuthenticationFilter.class); // Nasz JWT filtr wchodzi przed standardowy
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(); // Haszowanie hasła
    }
}